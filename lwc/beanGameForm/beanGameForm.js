    ...
    save() {
        getCurrentContact()
            .then(result => {
                ...
                if (this.lstcon.Language__c === 'English') {
                    this.BEANGAME_URL = `https://mindcrowd2--devphase2.sandbox.my.site.com/MindCrowd/s/add-beangameparticipant-consent?participantcode=${this.lstcon.ParticipantCode__c}&campaign=bean%20game`;
                    console.log('participant code..', this.lstcon.ParticipantCode__c);
                } else if (this.lstcon.Language__c === 'Español') {
                    this.BEANGAME_URL = `https://mindcrowd2--devphase2.sandbox.my.site.com/MindCrowdES/s/adic/aceptaparticipardbs?campaign=DBS&participantcode=${this.lstcon.ParticipantCode__c}&campaign=bean%20game`;
                    console.log('participant code..', this.lstcon.ParticipantCode__c);
                }
