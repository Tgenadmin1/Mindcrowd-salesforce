({
    ...
    saveAudioToSalesforce: function(component, participantGameInfoId, binaryData) {
        console.log('reached helper: '+ participantGameInfoId);
        console.log('speechTaskrecList: '+ JSON.stringify(binaryData));
