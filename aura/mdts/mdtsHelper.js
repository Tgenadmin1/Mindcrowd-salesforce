({//this function is used forcreating the games record for every slide.
    //  component, event, helper, userContactId, gameId, questionNumber, response, isCorrect, reactionTime, isPracticeQuestion, correctAnswer, participantGameInfoId, name, trial, studyPosition, testPosition, trialType, round
recorData: function (component, event, helper, userContactId, gameId, questionNumber, response, isCorrect, reactionTime, isPracticeQuestion, correctAnswer, participantGameInfoId, name, trial, studyPosition, testPosition, trialType, round) {

var studyImagePosition = JSON.stringify(studyPosition);
var testImagePosition = JSON.stringify(testPosition);
// console.log('inside record data123 :',studyImagePosition,testImagePosition, participantGameInfoId);
let data = {
...
Round__c: round,
ImageName__c: name,
ImageType__c: trialType,
StudyImageCoordinate__c: studyImagePosition,
TestImageCoordinate__c: testImagePosition
};
...
//console.log('mycontactId id :',name);      
}
else if (state === "ERROR") {
let message = '';
let errors = response.getError();
...
//console.log('participantGamei id :',name);           
}
else if (state === "ERROR") {
let message = '';
let errors = response.getError();
