({//this function is used forcreating the games record for every slide.
    recorData: function (component, event, helper, userContactId, gameId, questionNumber, userInput, isCorrect, reactionTime, isPracticeQuestion, correctAnswer, participantGameInfoId, trial, name, imageType, round) {
        ...
        action.setCallback(this, function (a) {
            ...
            if (state === "SUCCESS") {
                ...
                //console.log('save data called',name);  
            }
            else if (state === "ERROR") {
                let message = '';
