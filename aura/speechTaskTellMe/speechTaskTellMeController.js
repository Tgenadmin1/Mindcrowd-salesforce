({
    myAction: function (component, event, helper) {
        ...
        var gameNameScientific = $A.get("$Label.c.scientific_game_Tell_me");
        ...
        actionGame.setCallback(this, function (a) {
            ...
            if (state === "SUCCESS") {
                ...
                if (name['Tell_Me__c'] == 'Locked' && pageUrl[1] == $A.get("$Label.c.url_me_speechTask")) {
                    component.set('v.showConfirmDialog', true);
                }
                else if (name['Tell_Me__c'] == 'Completed' && pageUrl[1] == $A.get("$Label.c.url_me_speechTask")) {
                    component.set('v.showConfirmDialog', true);
                }
                // full game code is started from else part.===========================
                else if (name['Tell_Me__c'] == 'Opened' && pageUrl[1] == $A.get("$Label.c.url_me_speechTask")) {
                                ...
                                if(currentScreent == 5 || currentScreent == 6){
                                    if(validateRadio(currentScreent)){
                                        ...
                                        if (currentScreent == 6 ) {         
                                            ...
                                            helper.updateSpeechTaskPGI(component,component.get("v.participantGameid"), 'Aging Well', 
