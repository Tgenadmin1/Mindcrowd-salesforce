                  ...
                  //console.log('New configdata: '+JSON.stringify(configdata));
                    ...
                    function changeScreen() {
                       ...
                       //  console.log('change screen',configdata[currentScreent].screen);
                        ...
                        if (configdata[currentScreent].screen == '241'
                        ...
                        if (configdata[currentScreent].screen == '209') {
                        ...
                        if (configdata[currentScreent].screen == '0'
                            || configdata[currentScreent].screen == '214' || configdata[currentScreent].screen == '210'
                            ...
                            } else if (configdata[currentScreent].screen == '214') {
                    ...
                    function gamePlay(e) {
                        ...
                        if (command_value == 13) {
                            FieldOnFocus.blur();
                            if (configdata[currentScreent - 1].screen == '241'
                            ...
                            } else if (configdata[currentScreent - 1].screen == '209') {
                    ...
                    function changeGameScreen(){
                        ...
                        if(currentScreent==0){
                            ...
                            uclientbtn.forEach((e)=>{
                                e.addEventListener('click', gamePlay, false);
                        ...
                        if(configdata[currentScreent].isGame){
