    ...
    myAction: function (component, event, helper) {
        ...
        if (!window.location.toString().includes("live-preview")) {
            if (localStorage.getItem('consent') != "true") {
                ...
                console.log("last my page: ", lastBrain);
                if (lastBrain != pageName8 && lastBrain != pageName9) {
                    window.location.href = localStorage.getItem('LastPage');
                }
                else if (localStorage.getItem('memoryGame8') == 'true') {
                    gamerun = true;
                    localStorage.setItem('memoryGame9', false);
        ...
        const configdata = [
            ...
            {
                screen: "96", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">ride | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "horse", question: 13, isPractice: false
            },
            { screen: "97", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "98", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
            ...
            {
                screen: "100", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">dress | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "boat", question: 15, isPractice: false
            },
            { screen: "101", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "102", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">care | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "door", question: 16, isPractice: false
            },
            { screen: "103", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "104", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">public | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "hard", question: 17, isPractice: false
            },
            { screen: "105", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "106", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">garden | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "grass", question: 18, isPractice: false
            },
            { screen: "107", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "108", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">candle | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "spoon", question: 19, isPractice: false
            },
            { screen: "109", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "110", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">apple | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "eat", question: 20, isPractice: false
            },
            { screen: "111", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "112", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">night | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "fast", question: 21, isPractice: false
            },
            { screen: "113", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "114", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">mouth | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "time", question: 22, isPractice: false
            },
            { screen: "115", startDuration: 0, endDuration: 500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "116", startDuration: 1, endDuration: 8000, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p>' +
                    '<p class="centers example-row"> <span class="example-box">under | <input autocomplete="off" type="text" name="solution" id="inputsolution" class="txt_input txt_placeholder"/> <span class="centers magenta-btn  btn-xlarge"><button id="enterBtn" class="slds-button" >' + $A.get("$Label.c.Memory_Game_Text_18") + '</button></span></span> </p>', command: [13, 13], result: true, answer: "life", question: 23, isPractice: false
            },
            { screen: "117", startDuration: 0, endDuration: 1500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_26") + '</p><p class="centers"></p>' },
            {
                screen: "118", startDuration: 0, endDuration: 8000, content: ''
            },
            { screen: "119", startDuration: 0, endDuration: 2500, content: '<div class="title "> <span>' + $A.get("$Label.c.Memory_Game_text_27") + '</span></div>' },

            {
                screen: "120", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "122", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "124", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "126", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "128", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "130", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "132", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "134", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "136", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "138", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "140", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
            ...
            {
                screen: "142", startDuration: 0, endDuration: 2500, content: '<p class="title3">' + $A.get("$Label.c.Memory_Game_text_23") + '</p>'
        ...
        function changeScreen() {
            ...
            if (currentScreent != 168) {
                ...
                if ((currentScreent > 45 && currentScreent < 69 &&  currentScreent % 2 === 0) || (currentScreent > 94 && currentScreent < 116 &&  currentScreent % 2 === 1) || (currentScreent > 143 && currentScreent < 167 &&  currentScreent % 2 === 0)  ) {
                    if (isKeyboad) {
